...
// const prices = products.reduce((acc, product, arr) => {
//     console.log(acc);// 0...100...400...1400
...
// let allCalories = party.filter((element) => element.desert !== 'Apple Pie').reduce((total, calor) => {
//     return total + calor.calories;
// }, 0);
